...
export const WORKFLOW_CYCLE_MS = 11800;
...
type HeroWorkflowAgentDemoProps = {
  onCycleComplete?: () => void;
};

/**
 * Workflow Agents — AP intake loop: SOP customization → Slack chat → learning metrics.
 */
export function HeroWorkflowAgentDemo({ onCycleComplete }: HeroWorkflowAgentDemoProps) {
